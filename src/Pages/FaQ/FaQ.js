...
const FaqsCard = (props) => {
  ...
  return (
    ...
    >
      <h4 className="cursor-pointer pb-5 flex items-center justify-between text-lg text-primary-900 font-medium">
        {faqsList.q}
        {state ? (
          <svg
      ...
      >
        <div>
          <p className="text-primary-900">{faqsList.a}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <section className="leading-relaxed mt-5  ">
      <div className="space-y-3 text-center">
        <h1 className="text-5xl text-primary-900 font-bold">Frequently Asked Questions</h1>
      </div>
